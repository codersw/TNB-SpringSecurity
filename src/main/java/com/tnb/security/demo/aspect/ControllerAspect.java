package com.tnb.security.demo.aspect;

import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.tnb.security.demo.constant.MdcConstant;
import com.tnb.security.demo.utils.CommonUtils;
...
public class ControllerAspect {
    ...
    @Pointcut("execution(public * com.tnb.security.demo.controller.*.*(..)) || target(com.tnb.security.demo.handler.GlobalExceptionHandler)))")
    public void webLog() {}
